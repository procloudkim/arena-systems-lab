...
| Unreal Engine | `Unreal/ArenaObserver` | C++ build, protocol automation, server 연결·수동 실행 | build/test 완료, 사람 화면 검증 대기 |
...
| Network Programming | .NET server와 두 engine client | loopback end-to-end test | server·Unity 완료, Unreal 화면 검증 대기 |
